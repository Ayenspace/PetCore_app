              ...
              child: Column(
                ...
                children: [
                  ...
                  _InfoRow(
                    ...
                    label: listing.category.name.toUpperCase(),
                  ),
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 12),
                          if (currentOrder.message.trim().isNotEmpty) ...[
                            Container(
                              width: double.infinity,
                          ...
                          if (currentOrder.sellerReply != null &&
                              currentOrder.sellerReply!.trim().isNotEmpty) ...[
                            Container(
                              width: double.infinity,
                              padding: const EdgeInsets.all(12),
                              decoration: BoxDecoration(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 4),
          Text(
            'Send a request to the seller for availability or delivery details.',
